  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex flex-col space-y-5 mt-[14rem]">
          <h4 className="text-[13px] md:text-[15px] font-semibold text-center">
            ...
            <span className="decoration-[#0074CC]/50 underline">
              Let&apos;s Talk
            </span>
          </h4>
          ...
          <div className="space-y-1">
            {/* <div className="flex items-center space-x-5 justify-center">
              <PhoneIcon className="text-[#0074CC]/50 h-6 w-6 animate-pulse" />
              <p className="text-[13px] md:text-[15px]">+2348102718467</p>
            </div> */}

            <div className="flex items-center space-x-5 justify-center">
              <EnvelopeIcon className="text-[#0074CC]/50 h-6 w-6 animate-pulse" />
              <p className="text-[10px] md:text-[12px]">
                chidinmaafogu@gmail.com
              </p>
            </div>

            <div className="flex items-center space-x-5 justify-center">
              <MapPinIcon className="text-[#0074CC]/50 h-6 w-6 animate-pulse" />
      ...
      >
        ...
        <button
          type="submit"
          className="bg-[#0074CC] py-5 px-10 rounded-md text-black font-bold text-lg"
        >
          Submit
        </button>
      </form>
